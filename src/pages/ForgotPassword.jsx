        ...
        <Formik
          ...
          onSubmit={async (values, { resetForm }) => {
            ...
            try {
              ...
              resetForm({ values: "" });
              setSuccess(
                "An email with password reset link will be sent to your registered email address"
              );
            } catch {
        ...
        >
          {({ errors, touched, isSubmitting, isValid }) => (
            <Form className="flex flex-col justify-center items-center w-[100%] rounded-lg bg-white-30 gap-y-[1rem] py-6 md:py-6 md:h-fit-content md:w-[40%] px-5 md:px-1  m-auto">
              ...
              {error ? (
                <p className="text-error text-center text-xs w-[20rem]">
                  {error}
                </p>
              ) : null}
              {success ? (
                <p className="text-success text-center text-xs w-[20rem]">
                  {success}
                </p>
              ) : null}
              <div className="w-[100%] flex flex-col items-center">
                ...
                />
                <AiOutlineMail
                  className="relative top-[-1.5em] left-[45%] md:left-[40%]"
                  color="blue"
                />
              ...
              <button
                ...
                className=" py-1 bg-primary-200 text-white-10 rounded-lg w-[100%] disabled:bg-primary-100 hover:bg-primary-500 md:w-[90%]"
              >
